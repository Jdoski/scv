// ============================================================
// EDIT THIS FILE to update the Rules page.
// Each section has a title and a list of rules (plain text).
// URLs inside a rule are automatically turned into links.
// ============================================================
...
export const ruleSections = [
  ...
  {
    title: "Time / Registration / Format",
    rules: [
  ...
  {
    title: "Other Rules On The Court",
    rules: [
